...
export const verifyPayment = async (req: Request, res: Response) => {
  ...
  const node = db.getNodeByPubkey('028c5cc91cd076439f2152591daf96d842ddf7ca4c0dbf9ea69152fdb84eccc8ee');
 ...
 * POST /api/posts/:id/invoice
 */
export const createInvoiceAmt = async (req: Request, res: Response) => {
